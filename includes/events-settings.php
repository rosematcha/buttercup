<?php
/**
 * Settings registration, field renderers, and admin pages for Buttercup.
 *
 * @package Buttercup
 */
...
/**
 * Register admin menu pages for Buttercup.
 */
...
/**
 * Register all Buttercup settings, sections, and fields.
 */
function buttercup_events_settings_init() {
	register_setting(
		'buttercup_events_sync',
		'buttercup_fb_app_id',
		array(
			'type'              => 'string',
	...
	add_settings_field(
		...
		'buttercup-events-sync',
		'buttercup_fb_sync_section',
		array( 'option' => 'buttercup_fb_app_id' )
	);
	...
	add_settings_field(
		...
		'buttercup-events-sync',
		'buttercup_fb_sync_section',
		array( 'option' => 'buttercup_fb_page_id' )
	);
 ...
 *
 * @param string $old_value Previous slug value.
...
/**
 * Render the Facebook sync settings section description.
 */
...
/**
 * Render a text input field for Facebook settings.
 *
 * @param array $args Field arguments including 'option' key.
 */
...
/**
 * Render the Facebook page access token field.
 */
...
/**
 * Render the Facebook sync interval select field.
 */
...
/**
 * Render the cache TTL select field.
 */
...
/**
 * Render the events settings section description.
 */
...
/**
 * Render the events per page number input field.
 */
...
/**
 * Render the events archive URL slug field.
 */
...
/**
 * Render the homepage feed settings section description.
 */
...
/**
 * Render the feed CTA button label text field.
 */
...
/**
 * Render the feed mast tag slug text field.
 */
...
/**
 * Render the feed home tag slug text field.
 */
...
/**
 * Render the tag showcase settings section description.
 */
...
/**
 * Render the showcase button label text field.
 */
...
/**
 * Render the showcase max items number field.
 */
...
/**
 * Render the showcase image aspect ratio select field.
 */
...
/**
 * Render the team settings section description.
 */
...
/**
 * Render the team image shape select field.
 */
...
/**
 * Render the team image size number field.
 */
...
/**
 * Render the main Buttercup settings page.
 */
...
/**
 * Render the events sync admin page with status, settings, and manual sync button.
 */
