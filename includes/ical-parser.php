...
function buttercup_parse_ical_vevent($block, $default_tz = '')
{
    ...
    foreach ($lines as $line) {
        ...
        // e.g., DTSTART;TZID=America/Chicago:20260415T190000
...
function buttercup_ical_parse_datetime($value, $params = '', $default_tz = '')
{
    ...
    if (stripos($params, 'VALUE=DATE') !== false && strlen($value) === 8) {
        // YYYYMMDD → Y-m-d 00:00:00
        $ts = strtotime($value);
    ...
    // Normalize the datetime string: YYYYMMDDTHHMMSS → Y-m-d H:i:s
...
function buttercup_ical_resolve_timezone($tzid, $fallback)
{
    ...
    // e.g., "/mozilla.org/20050126_1/America/Chicago" → "America/Chicago"
