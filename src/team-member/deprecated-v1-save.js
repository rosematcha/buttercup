...
export default function save( { attributes } ) {
	...
	const safeLinks = ( socialLinks || [] ).filter( ( link ) =>
		link?.url?.trim()
	);
	...
	return (
		<article
			{ ...useBlockProps.save( { className: 'buttercup-team-member' } ) }
		>
			{ profileImageUrl && (
			...
			<div className="buttercup-team-member__text">
				...
				{ ( pronouns || position ) && (
					<p className="buttercup-team-member__subtitle">
						...
						{ pronouns && position && (
							<span className="buttercup-team-member__sep">
								{ ' ' }
								·{ ' ' }
							</span>
						) }
						{ position && (
							<span className="buttercup-team-member__position">
								{ position }
							</span>
						) }
					</p>
				...
				{ bio && showBio && (
					<div className="buttercup-team-member__bio-wrap">
						...
						/>
						<button
							className="buttercup-team-member__bio-toggle"
							aria-expanded="false"
						>
						...
						{ safeLinks.map( ( link, i ) => {
							...
							return (
								...
								>
									...
									<span className="buttercup-social-link__label">
										{ getPlatformLabel( link.platform ) }
									</span>
								</a>
							);
